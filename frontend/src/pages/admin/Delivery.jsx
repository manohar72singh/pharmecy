...
export default function AdminDelivery() {
  ...
  const handleAssign = async (orderId, deliveryBoyId) => {
    ...
    try {
      ...
      // ✅ OTP save karo show karne ke liye
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-white rounded-2xl border border-gray-100 p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Online Boys</p>
          </div>
        </div>
        <div className="bg-white rounded-2xl border border-gray-100 p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Offline Boys</p>
          </div>
        </div>
        {/* All delivery boys list */}
                        ...
                        {order.delivery_boy_name ? (
                          <div className="space-y-1">
                            ...
                            <select
                              ...
                              disabled={assigning === order.id}
                              className="text-xs px-2 py-1 rounded-lg border border-gray-200 focus:outline-none focus:border-emerald-400 text-gray-500"
                            >
                              <option value="" disabled>
                                Re-assign...
                              </option>
