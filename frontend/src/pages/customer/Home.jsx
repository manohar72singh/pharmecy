          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-white font-black">MediShop</span>
              </div>
            ...
            {[
              {
                title: "Quick Links",
                links: ["Home", "Medicines", "Offers", "About Us"],
              },
              {
                title: "My Account",
                links: ["Login", "Register", "My Orders", "Prescriptions"],
              },
              {
                title: "Contact",
                links: [
                  "📞 9771157571",
                  "📧 manohar72singh@gmail.com",
                  "🕐 24/7 Support",
                ],
              },
            ].map((col) => (
              <div key={col.title}>
                ...
                {col.links.map((l) => (
                  <div
                    key={l}
                    className="text-xs py-1 hover:text-white cursor-pointer transition"
                  >
                    {l}
                  </div>
                ))}
